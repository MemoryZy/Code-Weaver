package cn.memoryzy.code.bundle;
 ...
 * @since 2025/4/16
 */
public class CodeWeaverBundle extends AbstractBundle {

    private static final Logger LOG = Logger.getInstance(CodeWeaverBundle.class);

    private static final String BUNDLE = "messages.CodeWeaverBundle";
    ...
    private static final CodeWeaverBundle INSTANCE = new CodeWeaverBundle(BUNDLE);

    public CodeWeaverBundle(@NonNls @NotNull String pathToBundle) {
        super(pathToBundle);

package cn.memoryzy.code;

import cn.memoryzy.code.model.Version;
 ...
 * @since 2025/4/21
 */
public class CodeWeaverPlugin {
    public static final String PLUGIN_ID = "cn.memoryzy.code";
    public static final String PLUGIN_NAME = "Code Weaver";
    public static final String PLUGIN_ID_NAME = PLUGIN_ID + ".Code-Weaver";
